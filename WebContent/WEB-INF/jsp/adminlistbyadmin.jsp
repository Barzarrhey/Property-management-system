...
<body bgcolor="d3eaea">
	<div class="right">
		...
		<pg:pager url="pgAdminListbyadmin.html" items="${totalRecord}"
           ...
           <pg:param name="adminName" value="${adminName }"/>
			<pg:param name="adminPhone" value="${adminPhone}"/>
               <br>
				<form method="post"
					action="adminquerybyadmin.html">
                   <td width="10%" height="35" bgcolor="d3eaef" class="STYLE6"><div>
					<span class="STYLE19">用户名：</span> <input name="adminName" class="input-text"
						type="text" value="${adminName}"> <span class="STYLE19">用户电话：</span> <input
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
				<tr class="firstTr">
					...
					<td width="20" height="35" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">操作</td>
					<br/>
				</tr>
				<c:forEach var="ad" items="${adminList}" varStatus="status">
					<tr>
						...
						<td height="35" bgcolor="d3eaed" class="STYLE19"><div align="center"><span>
                           <form name="compsolve" method="post" onsubmit="return ifsumbit()" action="admindelete.html"> 
								<input type="hidden"  name="adminId" value="${ad.adminId}" />
